  ...
  setup() {
    ...
    function handleHelp() {
      ...
      switch(activeIndex.value) {
        case "Dashboard":
          helpMessage.value = "<p>Enter a gene name into the search bar to bring up information and graphs.</p><p>Alternatively, click advanced search for more search options:</p><p><b>Option 1:</b> search by terms</p><div style='margin-left: 10px;'><span><b>Step 1:</b> select a cardiomyopathy type</span></br><span><b>Step 2:</b> you will now be able to use the select box below to select from a list of diseases that are associated with the phenotype</span></br><span><b>Step 3:</b> click the display button to show the results below</span></div><p><b>Option 2:</b> search by gene</p><div style='margin-left: 10px;'><span><b>Step 1:</b> click the genes tab to switch forms</span></br><span><b>Step 2:</b> select a gene name</span></br><span><b>Step 3:</b> select from a list of diseases that are associated with the phenotype</span></br><span><b>Step 4:</b> click the display button to show the results below</span><p><b>Option 3:</b> click the X to close the advanced search</p></div>"
          break;
        case "AddData":
          helpMessage.value = "<h3>Fill in the form and upload a csv file to create your own graphs.</h3><p><b>Step 1:</b> enter a phenotype</p><p><b>Step 2:</b> enter gene name</p><p><b>Step 3:</b> enter a title for the graph</p><p><b>Step 4:</b> add notes if you like</p><p><b>Step 5:</b> click on the green button to upload csv</p><p><b>Step 6:</b> click the blue upload button then click ok to upload to the site</p>"
          break;
        case "DeleteData":
          helpMessage.value = "<p>This form allows you to delete data from the database.</p><p><b>Step 1:</b> select a term from any of the options</p><p><b>Step 2:</b> click on the corresponding button to find the associated data</p>"
          break;
        default: helpMessage.value = "no help available."
      }
    }
